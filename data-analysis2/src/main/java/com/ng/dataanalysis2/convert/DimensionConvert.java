...
public class DimensionConvert {
    ...
    public static int getDimensionId(IDimension iDimension) {
        // 1. 先从内存去读id, 如果读不到   telephone_name
     ...
     * @return
     */
    private synchronized static int execSqls(Connection conn, String[] sqls, IDimension iDimension) {
     ...
     * @return
     */
    public static String[] getSqls(IDimension iDimension) {
